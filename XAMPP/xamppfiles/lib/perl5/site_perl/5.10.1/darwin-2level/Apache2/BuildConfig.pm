...
#  * 04: /Applications/XAMPP/xamppfiles/var/perl/cpanplus/5.10.1/build/mod_perl-2.0.4/Makefile.PL:405
#  * 05: /Applications/XAMPP/xamppfiles/var/perl/cpanplus/5.10.1/build/mod_perl-2.0.4/Makefile.PL:96
#  * 06: /Applications/XAMPP/xamppfiles/bin/cpanp-run-perl:5
#  */
# 
...
sub new {
    bless( {
        'API_VERSION' => 2,
        'APXS_APR_BINDIR' => '/Applications/XAMPP/xamppfiles/bin',
        'APXS_APU_BINDIR' => '/Applications/XAMPP/xamppfiles/bin',
        'APXS_BINDIR' => '/Applications/XAMPP/xamppfiles/bin',
        'APXS_EXTRA_CFLAGS' => '',
        'APXS_EXTRA_CPPFLAGS' => '-DDARWIN -DSIGPROCMASK_SETS_THREAD_MASK -no-cpp-precomp',
        'APXS_INCLUDEDIR' => '/Applications/XAMPP/xamppfiles/include',
        'APXS_LIBEXECDIR' => '/Applications/XAMPP/xamppfiles/modules',
        'APXS_NOTEST_CPPFLAGS' => '',
        'MODPERL_AP_INCLUDEDIR' => '/Applications/XAMPP/xamppfiles/include',
        'MODPERL_AP_LIBEXECDIR' => '/Applications/XAMPP/xamppfiles/modules',
        'MODPERL_AP_LIBS' => '',
        'MODPERL_AR' => 'ar',
        'MODPERL_ARCHLIBEXP' => '/Applications/XAMPP/xamppfiles/lib/perl5/5.10.1/darwin-2level',
        'MODPERL_CC' => 'cc',
        'MODPERL_CCCDLFLAGS' => ' ',
        'MODPERL_CCOPTS' => ' -fno-common -DPERL_DARWIN -no-cpp-precomp -arch i386 -arch ppc -fno-strict-aliasing -pipe -I/Applications/XAMPP/xamppfiles/lib/perl5/5.10.1/darwin-2level/CORE -DMOD_PERL -DMP_COMPAT_1X -DDARWIN -DSIGPROCMASK_SETS_THREAD_MASK -no-cpp-precomp',
        'MODPERL_CP' => 'cp',
        'MODPERL_CPPRUN' => 'cc -E',
        ...
        'MODPERL_INC' => '-I/Applications/XAMPP/xamppfiles/var/perl/cpanplus/5.10.1/build/mod_perl-2.0.4/src/modules/perl -I/Applications/XAMPP/xamppfiles/var/perl/cpanplus/5.10.1/build/mod_perl-2.0.4/xs -I/Applications/XAMPP/xamppfiles/include -I/Applications/XAMPP/xamppfiles/include -I/Applications/XAMPP/xamppfiles/include -I/Applications/XAMPP/xamppfiles/include',
        'MODPERL_LD' => 'env MACOSX_DEPLOYMENT_TARGET=10.3 cc',
        'MODPERL_LDDLFLAGS' => ' -bundle -undefined dynamic_lookup -arch i386 -arch ppc -mmacosx-version-min=10.4',
        'MODPERL_LDOPTS' => ' -arch i386 -arch ppc  -arch i386 -arch ppc -mmacosx-version-min=10.4  -L/Applications/XAMPP/xamppfiles/lib/perl5/5.10.1/darwin-2level/CORE -lperl -ldl -lm -lc',
        'MODPERL_LIB' => 'mod_perl.so',
        'MODPERL_LIBNAME' => 'mod_perl',
        'MODPERL_LIBPERL' => '/Applications/XAMPP/xamppfiles/lib/perl5/5.10.1/darwin-2level/CORE/libperl.a',
        ...
        'MODPERL_PERLPATH' => '/Applications/XAMPP/xamppfiles/bin/perl',
        'MODPERL_PRIVLIBEXP' => '/Applications/XAMPP/xamppfiles/lib/perl5/5.10.1',
        'MODPERL_RANLIB' => '/usr/bin/ar s',
        'MODPERL_RM' => 'rm',
        'MODPERL_RM_F' => 'rm -f',
        'MODPERL_TEST_F' => 'test -f',
        'MODPERL_XSUBPP' => '$(MODPERL_PERLPATH) $(MODPERL_PRIVLIBEXP)/ExtUtils/xsubpp -typemap $(MODPERL_PRIVLIBEXP)/ExtUtils/typemap -typemap /Applications/XAMPP/xamppfiles/var/perl/cpanplus/5.10.1/build/mod_perl-2.0.4/lib/typemap',
        'MP_APR_LIB' => 'aprext',
        'MP_APXS' => '/Applications/XAMPP/xamppfiles/bin/apxs',
        'MP_COMPAT_1X' => 1,
        'MP_GENERATE_XS' => 1,
        'MP_LIBNAME' => 'mod_perl',
        'MP_USE_DSO' => 1,
        'VERSION' => '2.0.4',
        'XS' => {},
        'ap_includedir' => '/Applications/XAMPP/xamppfiles/include',
        ...
        'apr_config_path' => '/Applications/XAMPP/xamppfiles/bin/apr-1-config',
        'apr_includedir' => '/Applications/XAMPP/xamppfiles/include',
        'apu_config_path' => '/Applications/XAMPP/xamppfiles/bin/apu-1-config',
        'cwd' => '/Applications/XAMPP/xamppfiles/var/perl/cpanplus/5.10.1/build/mod_perl-2.0.4',
        'dir' => undef,
        ...
        'httpd_version' => {
                             '/Applications/XAMPP/xamppfiles/include' => '2.2.14'
                           }
      }, 'Apache2::Build' );
}
